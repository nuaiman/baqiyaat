...
class Lesson6Card extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Lesson6Card> createState() => _Lesson6CardState();
}

class _Lesson6CardState extends ConsumerState<Lesson6Card> {
        ...
        return GestureDetector(
          onTap: () {
            ...
            ref
                ...
                .play('assets/audio/qaida/lesson6/${widget.itemKey}.m4a');
          },
          child: Card(
