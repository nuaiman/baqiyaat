...
class Lesson5Card extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<Lesson5Card> createState() => _Lesson5CardState();
}

class _Lesson5CardState extends ConsumerState<Lesson5Card> {
        ...
        return GestureDetector(
          onTap: () {
            ...
            ref
                ...
                .play('assets/audio/qaida/lesson5/${widget.itemKey}.m4a');
          },
          child: Card(
